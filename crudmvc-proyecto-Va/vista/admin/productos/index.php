    ...
    <div class="col-12">
        <div class="card my-4">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" href="?controlador=productos&accion=frmConsultar">Consultar Productos</a> <br>
                        ...
                        foreach ($this->datos as $valor){
                            ...
                            echo "<tr>";
                               ...
                               // echo  "<td>".$valor["Pro_Descripcion"]."</td>";
                                ...
                                echo  "<td>
                                    <a href='?controlador=productos&accion=eliminar&cod=$cod'class='eliminar btn btn-danger' >Eliminar</a>
                                    </td>";
                            echo "</tr>";
                        }
                    ?>
