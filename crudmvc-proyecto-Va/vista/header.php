      ...
      <div class="container-fluid">
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="?controlador=inicio&accion=index" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
              <!-- <img src="public/logoani/aniA.png" width="85" height="75" alt="Logo"> -->

              <h2 style="font-family:cursive;">Ani Pasteleria . .</h2>
            ...
            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
              <li>
                <a href="?controlador=inicio&accion=index" class="nav-link text-white">
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a class="dropdown-item" href="?controlador=pedido&accion=listarPedidos">Pedido Estandar</a></li>
                  
                  <li><a class="dropdown-item" href="https://api.whatsapp.com/message/LP7PN5MRLECHK1?autoload=1&app_absent=0">Pedido Personalizado</a></li>
                </ul>
              </li>

            
              <li>
                <a href="?controlador=inicio&accion=frmListarProUsu" class="nav-link text-white">
       ...
       <?php if(!isset($_SESSION["nombre"])){ ?>
              ...
              <li>
                <a href="?controlador=inicio&accion=frmLogin" class="nav-link text-white">
              ...
              <?php }else{ ?>
                <li class="nav-item dropdown">
                <a class="nav-link text-white dropdown-toggle" id="navbarDropdown-1" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                    <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                    <path fill-rule="evenodd" d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                  </svg>
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown-1">
                  ...
                  <li><a class="dropdown-item" href="?controlador=inicio&accion=cerrar">Cerrar Sesion</a></li>
             ...
             <?php } ?>
              ...
              <li>
              <a href="?controlador=inicio&accion=CarritoCompra" style="margin-top: -0px;" id="carro" class="nav-link text-white">
              <svg xmlns="http://www.w3.org/2000/svg"  width="24"  fill="currentColor"   class="bi bi-cart4" viewBox="0 0 16 16"> <path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z" /> </svg>
                Carrito
              </a>
            </li>
            </ul>
      ...
      <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            ...
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false">
