...
<head>
  ...
  <link rel="stylesheet" href="public\assets\css\diseño.css">
</head>
...
<svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
  ...
  <header>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark justify-content-end">
      ...
      <div style="font-family: cursive; color:white">
        <section>

          <?php if (isset($_SESSION["nombre"])) { ?>
            <?php echo $_SESSION["nombre"], "[" . $_SESSION["rol"] . "]<br>"; ?>

            <a href="?controlador=inicio&accion=cerrar">
        ...
        <div class="container">
          <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <a href="/" class="d-flex align-items-center my-2 my-lg-0 me-lg-auto text-white text-decoration-none">
              ...
              <h2 style="font-family:cursive;">Anie Pasteleria</h2>
            ...
            <ul class="nav-menu nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
              <li class="nav-item">
                <a href="?controlador=inicio&accion=index" class="ancla nav-link text-white">
              ...
              <li class="nav-item">
                <a href="#" class="ancla nav-link text-white">
              ...
              <li class="nav-item">
                <a href="?controlador=inicio&accion=frmListarProUsu" class="ancla nav-link text-white">
              ...
              <li class="nav-item">
                <a href="?controlador=inicio&accion=frmLogin" class="ancla nav-link text-white">
              ...
              <li class="car">
              <a href="?controlador=inicio&accion=CarritoCompra" class="nav-link text-white" id="carro1"></a>                          
              <a href="?controlador=inicio&accion=CarritoCompra" class="circle nav-link text-white" id="carro2"></a>
            </li>
            </ul>
          </div>
        </div>
