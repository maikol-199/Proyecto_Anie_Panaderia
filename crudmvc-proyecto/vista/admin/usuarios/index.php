    ...
    <div class="col-12">
        <div class="card my-4">
            ...
            <div class="card-body">
                    ...
                    <a class="btn btn-primary" href="?controlador=usuarios&accion=frmConsultar">Consultar Usuario</a> <br>
                        ...
                        <?php
                            foreach ($this->datos as $valor){
                                ...
                                echo "<tr>";
                                    ...
                                    echo  "<td>
                                        <a href='?controlador=usuarios&accion=eliminar&cod=$cod'class='eliminar btn btn-danger'>Eliminar</a>
                                        </td>";
                                echo "</tr>";
                            }
                        ?>
