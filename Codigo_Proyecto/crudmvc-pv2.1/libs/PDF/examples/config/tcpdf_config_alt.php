...
define ('K_PATH_IMAGES', "http://localhost/crudmvc-pv2.1/public/img/");

/**
 * Deafult image logo used be the default Header() method.
 * Please set here your own logo or an empty string to disable it.
 */
define ('PDF_HEADER_LOGO', 'ani.jpeg');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'biblioteca monsalve newlove');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "NIT 1122 \nwww.NEWLOVE.org");
