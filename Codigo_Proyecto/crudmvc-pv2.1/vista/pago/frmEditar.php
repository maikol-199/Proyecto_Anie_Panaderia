        ...
        <div class="card my-4">
            ...
            <div class="card-body">
                ...
                <form action="?controlador=pago&accion=editar" method="post" id="frmEditar" >
                    ...
                    <input type="number" name="pag_id_pago" value="<?php echo $this->datos["Pag_Id_Pago"];?>"  class="form-control">
                    </div>

                    <div class="input-group input-group-outline my-3">
                    <label class="form-label"></label>
                    <input type="text" name="pag_forma_pago" value="<?php echo $this->datos["Pag_Forma_Pago"];?>" class="form-control">
                    </div>
