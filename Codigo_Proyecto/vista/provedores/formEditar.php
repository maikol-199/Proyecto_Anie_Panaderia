        ...
        <div class="card my-4">
            ...
            <div class="card-body">
                <table class="table align-items-center mb-0">
                    <form action="?controlador=provedores&accion=editar" method="post"id="frmRegistro">
                        <div class="input-group input-group-outline my-3">
                            <label class="form-label"></label>
                            <input type="number" name="pro_id_provedor" value="<?php echo $this->datos["Pro_Id_Provedor"]; ?>" class="form-control">
                        </div>
                        <div class="input-group input-group-outline my-3">
                            <label class="form-label"></label>
