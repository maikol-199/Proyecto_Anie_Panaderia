<div class="row">
    <div class="col-12">
        <div class="card my-4">
            ...
            <div class="card-body">
                    <a class="btn btn-primary" href="?controlador=trabajadores&accion=frmRegistrar">Registrar trabajadores</a> <br>
                        ...
                        <?php
                            foreach ($this->datos as $valor){
                                ...
                                echo "<tr>";
                                    ...
                                    echo  "<td>
                                        <a href='?controlador=trabajadores&accion=eliminar&cod=$cod'>Eliminar</a>
                                        </td>";
                                echo "</tr>";
                            }
                        ?>
