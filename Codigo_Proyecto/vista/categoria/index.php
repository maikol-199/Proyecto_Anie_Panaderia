    ...
    <div class="col-12">
        <div class="card my-4">
            ...
            <div class="card-body">
                ...
                <a class="btn btn-primary" href="?controlador=categoria&accion=frmRegistrar">Registrar Categoria</a> <br>
                ...
                <table class="table align-items-center mb-0">
                    ...
                    foreach ($this->datos as $valor) {
                      ...
                      <a href='?controlador=categoria&accion=frmEditar&cod=$cod'>Editar</a>
                        ...
                        echo  "<td>
                      <a href='?controlador=categoria&accion=eliminar&cod=$cod'>Eliminar</a>
                      </td>";
                        echo "</tr>";
                    }
                    ?>
